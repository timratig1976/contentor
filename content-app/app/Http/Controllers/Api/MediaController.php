...
class MediaController extends Controller
{
    ...
    public function storeBriefing(Request $request): JsonResponse
    {
        ...
        $item = ContentItem::with('unit')->findOrFail($validated['item_id']);
        ...
        return response()->json($media->load(['contentItem', 'unit']), 201);
    }
    ...
    public function update(Request $request, ContentMedia $media): JsonResponse
    {
        ...
        return response()->json($media->load(['contentItem', 'unit']));
    }
